...
def main(specification: str, inputs: Sequence[Any], config: config_lib.Config, max_samples: int = None):
  ...
  samplers = [sampler.Sampler(database, evaluators, config.samples_per_prompt, max_samples)
  ...
  # Return the database for further analysis
  return database
